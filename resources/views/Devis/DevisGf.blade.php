...
<div id="container" style="margin-top:-2em;">
 ...
 <section id="features" style="padding:0">
  <div class="container">
      ...
      <form action="{{route('sendDevisGf',[1])}}" name="sendDevis" method="post">
          {{ csrf_field() }}
              ...
              <div role="tabpanel" class="tab-pane fade in active feat-sec" id="tab-1">
                  ...
                  <div class="col-md-6" style="padding:0 0 0 5%;">
                      ...
                      <div class="row" style="padding:8px;">
                       ...
                       <div class="col-md-8" style="padding:2% 0 0 5%">
                              <label class="container-checkbox">Êtes-vous un revendeur?
                                  <input type="checkbox" name="revendeur" value="0" id="_checkbox">
                                  <span class="checkmark"></span>
                              </label>
                        </div>
                  <div class="col-md-12" style="padding-top:2%;">
                      <h5> Machine que vous possédiez déjà:</h5>
                      <table class="table table-borderless" id="tablemachine">
                            <thead>
                                <tr>
                                    <td></td>
                                    <td>Photocopieur</td>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                       <div class="col-md-12">
                                            <input type="text" name="marquePhotocopieur" class="form-control">
                                       </div>
                                    </td>
                                    <td>
                                        <div class="col-md-12">
                                            <input type="text" name="marqueImprimante" class="form-control">
                                        </div>
                                    </td>
                                    <td>
                                        <div class="col-md-12">
                                            <input type="text" name="marqueScanner" class="form-control">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Modèle (nom+laser/jet d'encre)</td>
                                    <td>
                                        <div class="col-md-12">
                                            <input type="text" name="modelePhotocopieur" class="form-control">
                                        </div>
                                    </td>
                                    <td>
                                        <div class="col-md-12">
                                            <input type="text" name="modeleImprimante" class="form-control">
                                        </div>
                                    </td>
                                    <td>
                                        <div class="col-md-12">
                                            <input type="text" name="modelelScanner" class="form-control">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Année de l'achat</td>
                                    <td>
                                        <select id="dateYear" name="anneePhotocopieur">
                                          <?php for($year=1990; $year<=$prod['year'];$year++){ ?>
                                          <option  value=<?php echo $year?> >{{$year}}</option>
                                          <?php } ?>  
                                        </select>
                                    </td>
                                    <td>
                                        <select id="dateYear" name="anneeImprimante">
                                          <?php for($year=1990; $year<=$prod['year'];$year++){ ?>
                                          <option  value=<?php echo $year?> >{{$year}}</option>
                                          <?php } ?>  
                                        </select>
                                    ...
                                    <td>
                                        <select id="dateYear" name="anneeScanner">
                                          <?php for($year=1990; $year<=$prod['year'];$year++){ ?>
                                          <option  value=<?php echo $year?> >{{$year}}</option>
                                          <?php } ?>  
                                        </select>
                                ...
                                <tr>
                                    <td>Remarques</td>
                                    <td>
                                        <input type="text" name="remarquePhotocopieur" class="form-control">
                                    </td>
                                    <td>
                                        <input type="text" name="remarqueImprimante" class="form-control">
                                    </td>
                                    <td>
                                        <input type="text" name="remarqueScanner" class="form-control">
                                    </td>
                                </tr>
                            </tbody>
                      </table>
