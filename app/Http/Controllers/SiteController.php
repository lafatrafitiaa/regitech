...
// echo "acc";
   ...
   public function devisInfo(Request $request){
    ...
    public function sendDevisGf(Request $request){
      ...
      echo  $email=$request->emailClient;
        $tel=$request->tel;
        $activite=$request->activite;
        $poste=$request->poste;

    // possede
        $marquePhotocopieur=$request->marquePhotocopieur;
        $marqueImprimante=$request->marqueImprimante;
        $marqueScanner=$request->marqueScanner;

        $modelePhotocopieur=$request->modelePhotocopieur;
        $modeleImprimante=$request->modeleImprimante;
        $modeleScanner=$request->modeleScanner;

        $anneePhotocopieur=$request->anneePhotocopieur;
        $anneeImprimante=$request->anneeImprimante;
        $anneeScanner=$request->anneeScanner;

        $remarquePhotocopieur=$request->remarquePhotocopieur;
        $remarqueImprimante=$request->remarqueImprimante;
        $remarqueScanner=$request->remarqueScanner;
